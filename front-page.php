...
<?php get_header();  ?>
	...
	<div id="banner">	
		<ul class="bxslider">
			<li>		
				<div class="oneslide">
					<img src="<?php bloginfo('template_directory');  ?>/img/banner1.jpg" alt="">
		...
		<div class="container">			
			<div class="row">				
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">	
					...
					<span class="line os-animation" data-os-animation="rollIn" data-os-animation-delay="0.6s"></span>
				...
				<div class="container">			
					<div class="row">				
						...
						<div class="col-lg-6 col-md-6 col-sm-7 col-xs-12">	
							<img src="<?php bloginfo('template_directory');  ?>/img/slide1.jpg" alt="" class="os-animation" data-os-animation="fadeInRight" data-os-animation-delay="0.4s">
						</div>
					</div>
				</div>
			</li>
		...
		<div class="container">			
			<div class="row">				
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<p class="regular os-animation" data-os-animation="fadeInRight" data-os-animation-delay="0.4s">Quote of the day, from <a class="addborder" href="<?php bloginfo('template_directory');  ?>/#">Love Quotes</a></p>
				</div>
			</div> 
		</div>
	</section>
				...
				<div class="row">				
					<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
						<div class="imgdivleft">
							<img src="<?php  bloginfo('template_directory');  ?>/img/poster1.jpg" alt="" class="os-animation" data-os-animation="pulse" data-os-animation-delay="0.5s">						
							<div class="innercontent">
								<div class="bottom-text">
									<p class="innerp"><a href="<?php  bloginfo('template_directory');  ?>/#">BUY NOW</a></p>
									<p class="innerp"><a href="<?php  bloginfo('template_directory');  ?>/#">SHARE <i class="fa fa-share" aria-hidden="true"></i></a></p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">				
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">					
								<div class="imgdivright">
									<img src="<?php  bloginfo('template_directory');  ?>/img/poster2.jpg" alt="" class="os-animation" data-os-animation="pulse" data-os-animation-delay="0.6s">
								</div>
							</div>
						</div>					
						<div class="row">				
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="imgdivrightinner">					
									<img src="<?php bloginfo('template_directory');  ?>/img/poster3.jpg" alt="" class="os-animation" data-os-animation="pulse" data-os-animation-delay="0.7s">		
								</div>				
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="imgdivrightinner">					
									<img src="<?php bloginfo('template_directory');  ?>/img/poster4.jpg" alt="" class="os-animation" data-os-animation="pulse" data-os-animation-delay="0.8s">	
								</div>				
							</div>
						</div>
					</div>
